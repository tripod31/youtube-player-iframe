var Subtitle = function(startSec,endSec,texts){
...
SubManager.prototype.readSub =async function(url){
    ...
    */ 
    ...
    for (const line of lines) {
        ...
        if (m != null){
            // 時間指定行
            startSec = parseInt(m[1])*60*60+parseInt(m[2])*60+parseInt(m[3])
...
var SetuupVideo = async function () {
    // url引数取得
    ...
    var subFileUrl= 'sub/' + subFile
    //var subFileUrl= `${uri.protocol}//${uri.hostname}/youtube-player/sub/${subFile}`
